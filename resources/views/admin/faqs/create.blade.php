...
@section('content')
<x-admin.validation-errors title="تعذر حفظ السؤال:" />

<x-admin.card>
    <x-admin.section-heading
        title="بيانات السؤال"
        description="سيظهر السؤال في صفحة الأسئلة الشائعة بعد تفعيله."
    />
    ...
    <form action="{{ route('admin.faqs.store') }}" method="POST" class="space-y-6" id="faq-form">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div class="md:col-span-2">
                ...
                <x-admin.input type="text" name="question" id="question" :value="old('question')" required />
        ...
        <div>
            ...
            <div id="editor-container" class="rounded-b-tremor-default border-x border-b border-tremor-border">
                ...
                <textarea name="answer" id="answer-textarea" class="hidden min-h-32 w-full border-0 p-4 focus:outline-none focus:ring-2 focus:ring-tremor-brand" style="direction: rtl;" required>{{ old('answer') }}</textarea>
            </div>
